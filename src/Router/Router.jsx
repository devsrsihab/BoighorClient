...
const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      },
      {
        ...
        loader: () => fetch("https://boighore.vercel.app/books"),
      },
      {
        path: "/book/:id",
        element: (
        ...
        loader: ({ params }) =>
          fetch(`https://boighore.vercel.app/book/${params.id}`),
      },
      {
        path: "/books/:category",
        element: (
        ...
        loader: ({ params }) =>
          fetch(`https://boighore.vercel.app/books/${params.category}`),
      },
      {
        path: "/borrowdBooks",
        element: (
  ...
  },
  {
    ...
    loader: () => fetch("https://boighore.vercel.app/users"),
    errorElement: <ErrorPage />,
    children: [
      {
        path: "",
